...
export default function Skills() {
  return (
    <section id="skills" className="py-20 bg-background relative overflow-hidden">
      ...
      >
        <motion.div
          className="flex w-max space-x-12 px-8"
          animate={{ x: ["0%", "-50%"] }}
        ...
        >
          {[...skills, ...skills, ...skills, ...skills].map((skill, index) => (
            <div
              key={index}
              className="group flex flex-col items-center justify-center py-4 w-28 transition-all duration-500 hover:-translate-y-2 flex-shrink-0"
              style={{
            ...
            >
              ...
              <div className="relative z-10 transform group-hover:scale-110 transition-transform duration-500">
                ...
                {skill.type === "adobe" ? (
                  <div className={`w-20 h-20 flex items-center justify-center rounded-2xl shadow-lg ${skill.bgColor}`}>
                    <span className={`text-3xl font-bold ${skill.textColor}`}>{skill.symbol}</span>
                  </div>
                ) : skill.type === "capcut" ? (
                   <div className="w-20 h-20 rounded-2xl bg-black flex items-center justify-center relative overflow-hidden shadow-lg">
                      ...
                      <svg viewBox="0 0 48 48" className="w-12 h-12 text-white fill-current z-10">
                   ...
                   <div className="w-20 h-20 rounded-full bg-gradient-to-tr from-[#00C4CC] to-[#7D2AE8] flex items-center justify-center shadow-lg group-hover:shadow-[0_0_20px_rgba(0,196,204,0.4)] transition-shadow">
                  ...
                  <div className="w-20 h-20 rounded-full bg-black border border-white/20 flex items-center justify-center shadow-lg group-hover:shadow-white/20 transition-shadow">
                   ...
                   <div className="group-hover:animate-spin-slow transition-all">
                      <svg viewBox="-11.5 -10.23174 23 20.46348" className="w-20 h-20 drop-shadow-[0_0_15px_rgba(97,218,251,0.5)]">
                    ...
                    <div className="w-20 h-20 flex items-center justify-center bg-[#777BB4] rounded-full shadow-lg group-hover:shadow-[0_0_20px_rgba(119,123,180,0.5)] transition-shadow">
                   ...
                   <div className="filter drop-shadow-[0_0_10px_rgba(227,79,38,0.3)] group-hover:drop-shadow-[0_0_20px_rgba(227,79,38,0.6)] transition-all">
                     <svg viewBox="0 0 512 512" className="w-20 h-20 text-[#E34F26] fill-current">
            ...
            <h3 className="mt-4 text-base font-medium text-gray-300 group-hover:text-white transition-colors whitespace-nowrap">{skill.name}</h3>
          </div>
          ))}
        </motion.div>
      </div>
